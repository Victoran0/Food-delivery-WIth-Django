...
SECRET_KEY = 'django-insecure-1b^aj*4s_xvgpdke_s3jbx_s=oay0j%@p#s)sl08v1z4hsk@ck'
...
# Sending email after order confirmation
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# Prevent random person from signing up
